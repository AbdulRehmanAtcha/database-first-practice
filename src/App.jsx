...
function Main() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      cloudinaryData.append("upload_preset", "WebPictures");
      cloudinaryData.append("cloud_name", "ddzibxg31");
      console.log(cloudinaryData);

      axios.post(`https://api.cloudinary.com/v1_1/ddzibxg31/image/upload`,
        cloudinaryData,
        {
            ...
            {posts.map((eachPost, i) => (
              <div className="post" key={i}>
                ...
                <p id="userPost">{(eachPost.id === editing.editingId) ?
                  ...
                  eachPost?.yourPost}</p>
                  <br />
                  <img id="upload-pic" src={eachPost?.img} alt="" />
